...
# Make work with recent PyTorch versions (https://github.com/pytorch/pytorch/issues/37377)
...
def main(cfg) -> None:
    ...
    try:
        print("Experiment log dir:", cfg.launcher.experiment_log_dir)
        print("LR = %.2e" % cfg.lr) 
        print("Total_batch_size:", cfg.total_batch_size)
        print("############################################################\n\n\n")
    except:
        pass
